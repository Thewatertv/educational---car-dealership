...
namespace DB_Car_Dealership {
    ...
    public partial class Lada_AvtosalonDataSet : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StaffRow AddStaffRow(string Login) {
...
namespace DB_Car_Dealership.Lada_AvtosalonDataSetTableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Staff] WHERE (([id] = @Original_id) AND ((@IsNull_Login = 1 AN" +
                "D [Login] IS NULL) OR ([Login] = @Original_Login)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Staff] ([Login]) VALUES (@Login);\r\nSELECT id, Login FROM Staff" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Staff] SET [Login] = @Login WHERE (([id] = @Original_id) AND ((@IsN" +
                "ull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)));\r\nSELECT id," +
                " Login FROM Staff WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Login FROM dbo.Staff";
        ...
        public virtual int Fill(Lada_AvtosalonDataSet.StaffDataTable dataTable) {
        ...
        public virtual Lada_AvtosalonDataSet.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Lada_AvtosalonDataSet.StaffDataTable dataTable = new Lada_AvtosalonDataSet.StaffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Lada_AvtosalonDataSet.StaffDataTable dataTable) {
        ...
        public virtual int Update(string Login, int Original_id, string Original_Login, int id) {
            if ((Login == null)) {
        ...
        public virtual int Update(string Login, int Original_id, string Original_Login) {
            return this.Update(Login, Original_id, Original_Login, Original_id);
        }
    }
